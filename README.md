...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/green-leaf-06f7)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/green-leaf-06f7
```

A live public deployment of this template is available at [https://green-leaf-06f7.templates.workers.dev](https://green-leaf-06f7.templates.workers.dev)
